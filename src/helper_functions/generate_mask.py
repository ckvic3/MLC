...
def multi2single(idsFile, classFreqFile):
    ...
    Args:
        idsFile: 文件路径，对应 mmcv格式文件， 文件内容为LT数据 ids
        classFreqFile: 文件路径，对应mmcv 格式文件， 文件内容为 id 对应的multi label 标签
...
if __name__ == '__main__':
    classFreqFile = "/home/pengpeng/MLC/appendix/VOCdevkit/longtail2012/class_freq.pkl"
    imgIdFile = "/home/pengpeng/MLC/appendix/VOCdevkit/longtail2012/img_id.txt"
    ids, masks = multi2single(imgIdFile,classFreqFile)
    print(len(ids))
    print(len(masks))
    ids = mmcv.load("/home/pengpeng/MLC/appendix/VOCdevkit/longtail2012/voc_m2s_ids.pkl")

    np.save("/home/pengpeng/MLC/appendix/VOCdevkit/longtail2012/masks.npy",masks)

    # mmcv.dump(ids,"/home/pengpeng/MLC/appendix/VOCdevkit/longtail2012/voc_m2s_ids.pkl")
    # mmcv.dump(masks,)