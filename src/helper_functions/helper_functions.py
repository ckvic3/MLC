...
class WarmUpLR(torch.optim.lr_scheduler._LRScheduler):
    ...
    def __init__(self, optimizer, total_iters, warm_ratio = 1.0 / 3, last_epoch=-1):
    ...
    def get_lr(self):
        ...
        """
        return [base_lr * self.warm_ratio + (base_lr - self.warm_ratio * base_lr ) * self.last_epoch / (self.total_iters + 1e-8) for base_lr in self.base_lrs]
