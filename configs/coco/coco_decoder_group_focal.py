...
model = dict(
    name="decoder",
    param = dict(num_classes=80,pretrained=True,num_of_groups=num_of_groups)
)
...
output_path = "/data/pengpeng/logs/{}_{}_{}_group_{}".format(dataset['name'],loss['name'],model['name'],num_of_groups)